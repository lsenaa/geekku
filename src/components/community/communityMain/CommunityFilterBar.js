  ...
  return (
    ...
    <div className={styles.filterContainer}>
      <div className={styles.filterBar}>
        <h2 className={styles.boardTitle} style={{ fontFamily: 'Santokki' }}>집들이 게시판</h2>
      ...
      <div className={styles.filterHeader}>
        ...
        <button className={styles.registerButton} onClick={handleCommunityBoardWrite}>등록하기</button>
      </div>
    </div>
  );
};
