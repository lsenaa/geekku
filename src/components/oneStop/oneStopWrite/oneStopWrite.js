    ...
    <div className="community-write-info">
      ...
      <form className="info-form">
        ...
        <div className="form-group">
          <label>거래 종류</label>
          <div className="region-input">
            <input type="radio" name="Itype" value="1" />
            전체 시공
            <input type="radio" name="Itype" value="2" />
            부분 시공
          </div>
        </div>
        ...
        <div className="form-group">
          <label> 연락처 공개 </label>
          <div className="region-input">
            <input type="radio" name="possible" value="1" />
            공개
            <input type="radio" name="possible" value="2" />
            비공개
          </div>
        </div>
        ...
        <div className="community-write-info">
          ...
          <textarea
            ...
            placeholder="기타 상세 내용을 1000자 이내로 작성해주세요."
          ></textarea>
        </div>
        <div className="region-input">
          ...
          <button className="cancle-button" onClick={handleCommunityBoard}>
            취소하기
          </button>
        </div>
      </form>
