      ...
      <div>
        ...
        <div className={styles.user}>
          ...
          <div className={styles.nameInfo}>
            <p id={styles.name}>홍길동</p>
            <p id={styles.info}>010-1234-5678</p>
            <p className={styles.upDate}>2024-11-01</p>
          </div>
        </div>
        ...
        <div className={styles.sectionWrap}>
          ...
          <div className={styles.sectionWrap}>
            ...
            <div className={styles.contentDeco}>
              ...
              <textarea readOnly>
                주어진 예산과 희망평수로 알아보고싶습니다.주어진 예산과
                희망평수로 알아보고싶습니다.주어진 예산과 희망평수로
                알아보고싶습니다.주어진 예산과 희망평수로 알아보고싶습니다.
              </textarea>
            </div>
          </div>
        </div>
