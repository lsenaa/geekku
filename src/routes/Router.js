...
import SearchId from 'components/login/search/SearchId';
...
import SearchPwd from 'components/login/search/SearchPwd';
import SearchPwdResult from 'components/login/search/SearchPwdResult';
